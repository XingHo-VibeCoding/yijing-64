...
> **项目名称**：易经六十四卦学习
> 文档版本：**v2.8** ｜ 日期：2026-09-22 ｜ 阶段：Day 7（**v2.8：深链接 + 上一卦/下一卦**）
>
...
| ⚠️ | **尚未做（v2.7 记录）**：F1 交互里的「**键盘上下移动 + 回车进入**」 | F1 |
...
| **详情页** | 返回（**按来源**回到总表或记录页）+ **翻页（‹ 上一卦 · 名称 / 名称 · 下一卦 ›，首尾卦对应按钮置灰）** + 收藏按钮、卦头（大卦符 + 卦名 + 吉凶徽章） | F2 |
